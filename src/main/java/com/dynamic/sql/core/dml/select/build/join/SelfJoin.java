...
public class SelfJoin extends JoinTable {
    ...
    public SelfJoin(Class<?> tableClass, String alias, Consumer<GenericWhereCondition> onCondition) {
        super(alias);
        this.tableClass = tableClass;
        this.onCondition = onCondition;
    }

    public SelfJoin(CteTable cteTable, Consumer<GenericWhereCondition> onCondition) {
        super(null);

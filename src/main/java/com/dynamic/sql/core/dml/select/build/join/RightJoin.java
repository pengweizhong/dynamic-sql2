...
public class RightJoin extends JoinTable {
    ...
    public RightJoin(Class<?> tableClass, String alias, Consumer<GenericWhereCondition> onCondition) {
        super(alias);
        this.tableClass = tableClass;
        this.onCondition = onCondition;
    }

    public RightJoin(CteTable cteTable, Consumer<GenericWhereCondition> onCondition) {
        super(null);
